...
# and use them as arguments when calling the python script.
...
# To call a different API endpoint, replace the request_path='API-ENDPOINT' statement.
# Usage: (Python3)
# ./armor_script_json_args.py API-KEY-ID SECRET-KEY
#
import base64
import hashlib
import hmac
